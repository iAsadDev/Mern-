  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-4xl px-8">
        <h1 className="text-5xl md:text-7xl font-bold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-amber-200 to-amber-400 font-serif tracking-wide">
          <span className="block text-4xl md:text-5xl mb-2 font-light italic text-amber-100">𝓦𝓮𝓵𝓬𝓸𝓶𝓮 𝓣𝓸</span>
          𝓟𝓻𝓮𝓶𝓲𝓾𝓶 𝓚𝓲𝓽𝓬𝓱𝓮𝓷
        </h1>
        
        {/* New Sophisticated Subtitle Design */}
        <div className="relative mb-8">
          <div className="flex items-center justify-center space-x-4">
            <div className="w-8 h-px bg-amber-300"></div>
            <p className="text-xl text-amber-50 font-medium tracking-widest uppercase">
              Masterfully Crafted Culinary Tools
            </p>
            <div className="w-8 h-px bg-amber-300"></div>
          </div>
          <p className="mt-4 text-lg text-amber-100/90 italic">
        ...
        <Link 
          to="/shop" 
          className="inline-flex items-center px-10 py-4 bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 text-amber-50 font-medium rounded-sm transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-xl shadow-amber-900/30 group"
        >
